...
export const POOL_ITEMS: PoolItem[] = [
  ...
  },
  {
    ...
    description: 'Operational dashboard to track the state of sharing requests using the latest status model, with error-to-status code linking for automated troubleshooting.',
    acceptanceCriteria: [
